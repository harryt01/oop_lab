...
public final class PrismSettings {
    ...
    static {
        ...
        // We need to parse the minimum Hi-DPI threshold here because PrismFont
        // needs it to compute the default system font size
        winMinDPIScale = getFloatDPI(systemProperties, "glass.win.minHiDPI", 1.5f);
    ...
    private static float getFloatDPI(Properties properties,
                                     String propname,
                                     float defval) {
        ...
        try {
            ...
            System.err.println("WARNING: Unable to parse " + propname);
