...
public class SwingNode extends Node {
    ...
    private static float getRenderScale(Window win) {
        return WindowHelper.getWindowAccessor().getRenderScale(win);
    }
    ...
    private void addWindowListeners(final Window window) {
        ...
        // The following is unneeded, since no public API for renderScale
        ...
        this.scale = Math.round(getRenderScale(window));
    ...
    private void locateLwFrame() {
        ...
        float renderScale = getRenderScale(w);
